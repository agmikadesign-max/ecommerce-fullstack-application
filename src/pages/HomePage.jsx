        ...
        <main className="pt-[120px] max-w-[1600px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {products.map((product) => (
              <div
                key={product.id}
                className="group bg-white p-5 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-300 flex flex-col justify-between relative overflow-hidden border border-gray-100"
              >
                  ...
                  <div className="flex items-center mb-4 space-x-2">
                    <div className="flex text-yellow-400 text-sm">
                      ...
                      <span className="text-gray-300">
                        {"★".repeat(5 - Math.floor(product.rating.stars))}
                      </span>
                    </div>
